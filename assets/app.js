...
// TWO COLLECTIONS ANIMATION EFFECT
...
twoCollectionTL
    ...
    .fromTo(
        '#twoCollections .left-c-image .collection-title',
        {
            y: 300,
            opacity: 0
        },
...
// HORIZONTAL SALE ANIMATION EFFECT
...
// PRODUCTS GROUP ANIMATION EFFECT

const
    productsGroupTL = gsap.timeline();
